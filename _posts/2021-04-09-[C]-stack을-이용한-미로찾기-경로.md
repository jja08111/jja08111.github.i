---
title: "[C] stack을 이용한 미로찾기 경로"
date: 2021-04-09 14:10:00 -0400
...
- 학교 수업으로 c언어로 미로찾기 알고리즘을 구현했습니다. 스택을 직접 구현하여 이용했습니다.

- 지나온 길을 `.`, 벽은 `1`, 빈 공간은 `0`으로 표시했습니다.

- 특징은 현재 지나온 길이 최단거리가 아닌 경우 경로에서 지웠습니다. 즉, 막다른 길에 다다른 경우 분기점까지 `0`으로 다시 변경했습니다.



### 실행 화면

![image-20210409145234856](C:\Users\민성\AppData\Roaming\Typora\typora-user-images\image-20210409145234856.png)
